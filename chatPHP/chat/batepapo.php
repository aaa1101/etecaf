...
/*
#voltar{ margin-top: -43px; background-color: #7FFFD4; color:#000000; border:none; cursor:pointer; border-radius:7px;margin-left: 405px; padding:5px; width: 100px;
     }*/
...
<div id="mensagens" name="mensagens">
    ...
    <div id="mensagem">
<form method="get" action="gravar_mensagem.php">
    <input type="text" name="mensagem" id="msg"><input type="submit" value="Enviar" id="entrar">
</form>

<!-- <a href="index.php"><input type="submit" value="Voltar" id="voltar"></a>
 -->
